 ...
 * @author JEFREY
 */
public class ComprobantePagoGUI extends javax.swing.JInternalFrame {
    ...
    private void generarSerie() {
        try {
            String serie = objComprobanteDAO.nroSerieComprobante();
            if (serie == null) {
    ...
    private void initComponents() {
        ...
        jLabelTitulo.setText("COMPROBANTE DE PAGO");
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        try {
            if (jtxtcodigoEncargadoEntrada.getText().trim().length() == 0
                    || jtxtcodigoCliente.getText().trim().length() == 0
                ...
                objEntradaTO.setIdproveedor(Integer.parseInt(jtxtcodigoCliente.getText()));
                objEntradaTO.setTotalent(total);
//                objComprobanteDAO.insert(objEntradaTO);
                xidentrada = objComprobanteDAO.obternerIDIngreso();
                /*DETALLE-ENTRADA*/
