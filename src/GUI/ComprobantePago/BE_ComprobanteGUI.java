 ...
 * @author JEFREY
 */
public class BE_ComprobanteGUI extends javax.swing.JInternalFrame {
    ...
    private void jbtnEnviarDataActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnEnviarDataActionPerformed
        try {
            ComprobantePagoGUI.jtxtcodigoEncargadoEntrada.setText(jtblBuscarEncargado.getValueAt(jtblBuscarEncargado.getSelectedRow(), 0).toString());
            ComprobantePagoGUI.jtxtnombreEncargadoEntrada.setText(jtblBuscarEncargado.getValueAt(jtblBuscarEncargado.getSelectedRow(), 1).toString());
        } catch (Exception e) {
