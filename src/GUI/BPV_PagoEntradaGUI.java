 ...
 * @author JEFREY
 */
public class BPV_PagoEntradaGUI extends javax.swing.JInternalFrame {

    DefaultTableModel objDtm;
    ResultSet rsProveedor;
    ProveedorDAO objProveedorDAO = new ProveedorDAO();

    public BPV_PagoEntradaGUI() {
        initComponents();
    ...
    private void jbtnEnviarDataActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnEnviarDataActionPerformed
        try {
            PagoEntradaGUI.jtxtcodigoProveedor.setText(jtblBuscarProveedor.getValueAt(jtblBuscarProveedor.getSelectedRow(), 0).toString());
            PagoEntradaGUI.jtxtnombreProveedor.setText(jtblBuscarProveedor.getValueAt(jtblBuscarProveedor.getSelectedRow(), 1).toString());
        } catch (Exception e) {
