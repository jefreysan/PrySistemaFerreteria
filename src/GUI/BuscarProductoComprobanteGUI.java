 ...
 * @author JEFREY
 */
public class BuscarProductoComprobanteGUI extends javax.swing.JInternalFrame {
    ...
    public BuscarProductoComprobanteGUI() {
        initComponents();
    ...
    private void initComponents() {
        ...
        if (jtblBuscarProductoComprobante.getColumnModel().getColumnCount() > 0) {
            jtblBuscarProductoComprobante.getColumnModel().getColumn(0).setResizable(false);
            jtblBuscarProductoComprobante.getColumnModel().getColumn(1).setResizable(false);
            jtblBuscarProductoComprobante.getColumnModel().getColumn(2).setResizable(false);
            jtblBuscarProductoComprobante.getColumnModel().getColumn(3).setResizable(false);
        }
        ...
        jLabel2.setText("BUSCAR PRODUCTO COMPROBANTE");
        ...
        try {
            ...
            if (!jtxtBuscarProducto.getText().isEmpty()) {
                ...
                while (rsProducto.next()) {
                    Object registro[] = {rsProducto.getInt(1), rsProducto.getString(4), rsProducto.getString(5),rsProducto.getDouble(7)};
    ...
    private void jbtnAgregarFacturaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnAgregarFacturaActionPerformed
        try {
            ComprobanteVentaGUI.jtxtcodigoProducto.setText(jtblBuscarProductoComprobante.getValueAt(jtblBuscarProductoComprobante.getSelectedRow(), 0).toString());
            ComprobanteVentaGUI.jtxtnombreProducto.setText(jtblBuscarProductoComprobante.getValueAt(jtblBuscarProductoComprobante.getSelectedRow(), 1).toString());
            ComprobanteVentaGUI.jtxtPrecioProducto.setText(jtblBuscarProductoComprobante.getValueAt(jtblBuscarProductoComprobante.getSelectedRow(), 3).toString());
